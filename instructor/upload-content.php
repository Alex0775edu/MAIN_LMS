...
<head>
  ...
  <meta name="description" content="Upload Content | Dhurandhar Instructor Portal page for the Dhurandhar Enterprise LMS frontend.">
  <title>Upload Content | Dhurandhar Instructor Portal</title>
        ...
        <section class="card-surface">
          <div class="page-header">
            <div>
              ...
              <p>Upload lesson media, documents, and starter assets with visibility control.</p>
            </div>
          ...
          <div class="row g-3"><div class="col-lg-7"><div class="card-surface"><h4 class="fw-bold mb-3">Upload assets</h4><div class="resource-card mb-2"><strong>Videos</strong><p class="text-muted mb-1">MP4 or MOV • 320 MB</p><div class="progress-track"><div class="progress-bar" style="width:72%"></div></div></div><div class="resource-card mb-2"><strong>Documents</strong><p class="text-muted mb-1">PDF, DOCX, or slides</p><div class="progress-track"><div class="progress-bar" style="width:46%"></div></div></div><div class="resource-card"><strong>Resources</strong><p class="text-muted mb-1">ZIP starter files</p><div class="progress-track"><div class="progress-bar" style="width:88%"></div></div></div></div></div><div class="col-lg-5"><div class="card-surface"><h4 class="fw-bold mb-3">Content library</h4><div class="resource-card mb-2"><strong>Lesson 1.mp4</strong><p class="text-muted mb-0">Uploaded 2 hrs ago</p></div><div class="resource-card"><strong>Exercise files.zip</strong><p class="text-muted mb-0">Uploaded 1 day ago</p></div></div></div></div>
        </section>
      </div>
    </main>
  </div>

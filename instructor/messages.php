...
<head>
  ...
  <meta name="description" content="Messages | Dhurandhar Instructor Portal page for the Dhurandhar Enterprise LMS frontend.">
  <title>Messages | Dhurandhar Instructor Portal</title>
      ...
      <div class="content-area">
        <section class="card-surface">
          <div class="page-header">
            <div>
              <h2>Messages</h2>
              <p>Stay in touch with learners and answer questions promptly.</p>
            </div>
          ...
          <div class="row g-3"><div class="col-lg-5"><div class="card-surface"><h4 class="fw-bold mb-3">Conversations</h4><div class="conversation-card mb-2"><strong>Meera Shah</strong><p class="text-muted mb-0">Your feedback is ready.</p></div><div class="conversation-card"><strong>Design cohort</strong><p class="text-muted mb-0">Please review the updated resources.</p></div></div></div><div class="col-lg-7"><div class="card-surface"><h4 class="fw-bold mb-3">Chat</h4><div class="resource-card mb-2"><strong>Rahul</strong><p class="text-muted mb-0">I’ve shared a new guide for your assignment.</p></div><div class="resource-card"><strong>Meera</strong><p class="text-muted mb-0">Thanks! I’m reviewing it now.</p></div></div></div></div>
        </section>
      </div>
    </main>
  </div>

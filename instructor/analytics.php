...
<head>
  ...
  <meta name="description" content="Analytics | Dhurandhar Instructor Portal page for the Dhurandhar Enterprise LMS frontend.">
  <title>Analytics | Dhurandhar Instructor Portal</title>
      ...
      <div class="content-area">
        <section class="card-surface">
          <div class="page-header">
            <div>
              <h2>Analytics</h2>
              <p>Review course performance, student momentum, and the best-performing content.</p>
            </div>
          ...
          <div class="row g-3"><div class="col-lg-8"><div class="card-surface"><h4 class="fw-bold mb-3">Learner growth</h4><div class="progress-track mb-2"><div class="progress-bar" style="width:92%"></div></div><p class="text-muted mb-0">Average completion rate across active learners.</p></div></div><div class="col-lg-4"><div class="card-surface"><h4 class="fw-bold mb-3">Top courses</h4><div class="timeline-card mb-2"><strong>AI Foundations</strong><p class="text-muted mb-0">1,284 learners</p></div><div class="timeline-card"><strong>Frontend Systems</strong><p class="text-muted mb-0">892 learners</p></div></div></div></div>
        </section>
      </div>
    </main>
  </div>

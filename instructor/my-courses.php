...
<head>
  ...
  <meta name="description" content="My Courses | Dhurandhar Instructor Portal page for the Dhurandhar Enterprise LMS frontend.">
  <title>My Courses | Dhurandhar Instructor Portal</title>
...
<body>
      ...
      <div class="content-area">
        <section class="card-surface">
          <div class="page-header">
            <div>
              <h2>My Courses</h2>
              <p>Organize and manage your course inventory with a polished library view.</p>
            </div>
  ...
  <div class="page-header">
    <div><h2>Course library</h2><p>Quickly update visibility, pricing, and progress for each course you teach.</p></div>
    <a href="create-course.php" class="btn btn-primary">New Course</a>
  </div>
  <div class="row g-3 mb-3">
    <div class="col-md-4"><input class="form-control" type="text" placeholder="Search course" data-search name="search_course"></div>
    <div class="col-md-4"><select class="form-select" name="field"><option>Published</option><option>Draft</option><option>Archived</option></select></div>
    <div class="col-md-4"><select class="form-select" name="field"><option>Newest</option><option>Popular</option><option>Revenue</option></select></div>
  </div>
  <div class="grid-cards">
    <article class="course-card" data-search-item><h5 class="fw-bold">Full Stack Web Development</h5><p class="text-muted">A practical path for modern web delivery.</p><div class="progress-track mb-2"><div class="progress-bar" style="width:84%"></div></div><div class="d-flex justify-content-between small text-muted"><span>84% complete</span><span>1,284 learners</span></div></article>
    <article class="course-card" data-search-item><h5 class="fw-bold">AI for Product Teams</h5><p class="text-muted">Prompting, automation, and workflow design.</p><div class="progress-track mb-2"><div class="progress-bar" style="width:58%"></div></div><div class="d-flex justify-content-between small text-muted"><span>58% complete</span><span>216 learners</span></div></article>
    <article class="course-card" data-search-item><h5 class="fw-bold">Design Systems Essentials</h5><p class="text-muted">Tokens, patterns, and scalable UI systems.</p><div class="progress-track mb-2"><div class="progress-bar" style="width:72%"></div></div><div class="d-flex justify-content-between small text-muted"><span>72% complete</span><span>548 learners</span></div></article>
  </div>
</div>
        </section>
      </div>

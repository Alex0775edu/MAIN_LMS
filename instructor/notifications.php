...
<head>
  ...
  <meta name="description" content="Notifications | Dhurandhar Instructor Portal page for the Dhurandhar Enterprise LMS frontend.">
  <title>Notifications | Dhurandhar Instructor Portal</title>
      ...
      <div class="content-area">
        <section class="card-surface">
          <div class="page-header">
            <div>
              <h2>Notifications</h2>
              <p>Keep all course events and learner signals visible in one place.</p>
            </div>
          ...
          <div class="card-surface"><h4 class="fw-bold mb-3">Notification center</h4><div class="timeline-card mb-2"><strong>New assignment submitted</strong><p class="text-muted mb-0">2 learners added work to the critique task.</p></div><div class="timeline-card mb-2"><strong>Live class reminder</strong><p class="text-muted mb-0">Your session begins in 30 minutes.</p></div><div class="timeline-card"><strong>Course review requested</strong><p class="text-muted mb-0">A learner wants feedback on a draft project.</p></div></div>
        </section>
      </div>
    </main>
  </div>

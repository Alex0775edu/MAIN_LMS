...
<head>
  ...
  <meta name="description" content="Assignments | Dhurandhar Instructor Portal page for the Dhurandhar Enterprise LMS frontend.">
  <title>Assignments | Dhurandhar Instructor Portal</title>
      ...
      <div class="content-area">
        <section class="card-surface">
          <div class="page-header">
            <div>
              <h2>Assignments</h2>
              <p>Review submissions and provide timely feedback to learners.</p>
            </div>
          ...
          <div class="row g-3"><div class="col-lg-8"><div class="card-surface"><h4 class="fw-bold mb-3">Submission queue</h4><div class="task-card mb-2"><strong>Landing page critique</strong><p class="text-muted mb-2">Meera Shah • Due today</p><button type="button" class="btn btn-outline btn-sm" data-toast="Feedback opened">Review</button></div><div class="task-card"><strong>Component review</strong><p class="text-muted mb-2">Arjun Rao • Due tomorrow</p><button type="button" class="btn btn-outline btn-sm" data-toast="Feedback opened">Review</button></div></div></div><div class="col-lg-4"><div class="card-surface"><h4 class="fw-bold mb-3">Rubric snapshot</h4><div class="timeline-card"><strong>Research & insight</strong><p class="text-muted mb-0">30%</p></div></div></div></div>
        </section>
      </div>
    </main>
  </div>

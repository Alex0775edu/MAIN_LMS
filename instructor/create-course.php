...
<head>
  ...
  <meta name="description" content="Create Course | Dhurandhar Instructor Portal page for the Dhurandhar Enterprise LMS frontend.">
  <title>Create Course | Dhurandhar Instructor Portal</title>
...
<body>
      ...
      <div class="content-area">
        <section class="card-surface">
          <div class="page-header">
            <div>
              <h2>Create Course</h2>
              <p>Create a polished course with guided steps, pricing, and modern media.</p>
            </div>
  ...
  <div class="page-header">
    <div><h2>Create a new course</h2><p>Set up a streamlined course experience with title, media, and learner outcomes.</p></div>
    <button type="button" class="btn btn-outline" data-toast="Saved as draft">Save Draft</button>
  </div>
  <div class="row g-3">
    <div class="col-md-6"><label class="form-label">Course title</label><input class="form-control" placeholder="e.g. AI Foundations" name="e_g_ai_foundations"></div>
    <div class="col-md-6"><label class="form-label">Category</label><select class="form-select" name="field"><option>Development</option><option>Design</option><option>Business</option><option>AI</option></select></div>
    <div class="col-md-6"><label class="form-label">Price</label><input class="form-control" type="number" value="4999" name="field"></div>
    <div class="col-md-6"><label class="form-label">Level</label><select class="form-select" name="field"><option>Beginner</option><option>Intermediate</option><option>Advanced</option></select></div>
    <div class="col-12"><label class="form-label">Description</label><textarea class="form-control" rows="4" placeholder="What will learners gain from this course?" name="what_will_learners_gain_from_this_course"></textarea></div>
    <div class="col-12"><label class="form-label">Learning outcomes</label><textarea class="form-control" rows="3" placeholder="List 4-6 outcomes" name="list_4_6_outcomes"></textarea></div>
    <div class="col-12"><button type="button" class="btn btn-primary" data-toast="Course ready for review">Review & Publish</button></div>
  </div>
</div>
        </section>
      </div>

...
<head>
  ...
  <meta name="description" content="Students | Dhurandhar Instructor Portal page for the Dhurandhar Enterprise LMS frontend.">
  <title>Students | Dhurandhar Instructor Portal</title>
      ...
      <div class="content-area">
        <section class="card-surface">
          <div class="page-header">
            <div>
              <h2>Students</h2>
              <p>Track learner activity, certificates, and classroom progress.</p>
            </div>
          ...
          <div class="card-surface"><div class="page-header"><div><h2>Learner roster</h2><p>Stay close to who is progressing, who is stuck, and who is ready for certification.</p></div><button type="button" class="btn btn-outline" data-toast="Export ready">Export</button></div><div class="table-responsive"><table class="table"><thead><tr><th>Student</th><th>Course</th><th>Progress</th><th>Status</th></tr></thead><tbody><tr data-search-item><td>Meera Shah</td><td>AI Foundations</td><td>82%</td><td><span class="badge-chip badge-success">On track</span></td></tr><tr data-search-item><td>Arjun Rao</td><td>Frontend Systems</td><td>68%</td><td><span class="badge-chip badge-warning">Needs support</span></td></tr></tbody></table></div></div>
        </section>
      </div>
    </main>
  </div>

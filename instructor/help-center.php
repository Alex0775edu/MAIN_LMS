...
<head>
  ...
  <meta name="description" content="Help Center | Dhurandhar Instructor Portal page for the Dhurandhar Enterprise LMS frontend.">
  <title>Help Center | Dhurandhar Instructor Portal</title>
      ...
      <div class="content-area">
        <section class="card-surface">
          <div class="page-header">
            <div>
              <h2>Help Center</h2>
              <p>Support learners, answer frequently asked questions, and manage requests.</p>
            </div>
          ...
          <div class="row g-3"><div class="col-lg-6"><div class="card-surface"><h4 class="fw-bold mb-3">FAQs</h4><div class="resource-card mb-2"><strong>How do I update my course content?</strong><p class="text-muted mb-0">Use the edit course view to refine content and pricing.</p></div><div class="resource-card"><strong>How can I issue certificates?</strong><p class="text-muted mb-0">Open the certificates page after a learner completes the final milestone.</p></div></div></div><div class="col-lg-6"><div class="card-surface"><h4 class="fw-bold mb-3">Support tickets</h4><div class="timeline-card mb-2"><strong>Video upload issue</strong><p class="text-muted mb-0">Open • Awaiting review</p></div><div class="timeline-card"><strong>Payment settings query</strong><p class="text-muted mb-0">Resolved • Response sent</p></div></div></div></div>
        </section>
      </div>
    </main>
  </div>

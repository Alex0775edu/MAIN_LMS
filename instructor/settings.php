...
<head>
  ...
  <meta name="description" content="Settings | Dhurandhar Instructor Portal page for the Dhurandhar Enterprise LMS frontend.">
  <title>Settings | Dhurandhar Instructor Portal</title>
      ...
      <div class="content-area">
        <section class="card-surface">
          <div class="page-header">
            <div>
              <h2>Settings</h2>
              <p>Configure preferences, notifications, and security options.</p>
            </div>

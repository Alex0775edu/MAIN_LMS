...
<head>
  ...
  <meta name="description" content="Edit Course | Dhurandhar Instructor Portal page for the Dhurandhar Enterprise LMS frontend.">
  <title>Edit Course | Dhurandhar Instructor Portal</title>
...
<body>
      ...
      <div class="content-area">
        <section class="card-surface">
          <div class="page-header">
            <div>
              <h2>Edit Course</h2>
              <p>Refine course details, pricing, and media after initial creation.</p>
            </div>
  ...
  <div class="page-header">
    <div><h2>Edit course</h2><p>Update lesson pacing, front matter, and pricing without losing momentum.</p></div>
    <button type="button" class="btn btn-primary" data-toast="Changes saved">Save Changes</button>
  </div>
  <div class="row g-3">
    <div class="col-md-6"><label class="form-label">Course name</label><input class="form-control" value="Full Stack Web Development" name="field"></div>
    <div class="col-md-6"><label class="form-label">Price</label><input class="form-control" value="4999" name="field"></div>
    <div class="col-12"><label class="form-label">Description</label><textarea class="form-control" rows="4" name="field">A practical course that combines responsive UI, clean architecture, and polished delivery.</textarea></div>
  </div>
</div>
        </section>
      </div>

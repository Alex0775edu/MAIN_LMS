...
<head>
  ...
  <meta name="description" content="Certificates | Dhurandhar Instructor Portal page for the Dhurandhar Enterprise LMS frontend.">
  <title>Certificates | Dhurandhar Instructor Portal</title>
      ...
      <div class="content-area">
        <section class="card-surface">
          <div class="page-header">
            <div>
              <h2>Certificates</h2>
              <p>Issue and manage learner certifications with confidence.</p>
            </div>
          ...
          <div class="row g-3"><div class="col-lg-7"><div class="card-surface"><h4 class="fw-bold mb-3">Issued certificates</h4><div class="resource-card mb-2"><strong>AI Foundations</strong><p class="text-muted mb-0">Issued to Meera Shah</p></div><div class="resource-card"><strong>Frontend Systems</strong><p class="text-muted mb-0">Issued to Arjun Rao</p></div></div></div><div class="col-lg-5"><div class="card-surface"><h4 class="fw-bold mb-3">Pending certificates</h4><div class="timeline-card mb-2"><strong>Nisha Rao</strong><p class="text-muted mb-0">Completion review pending</p></div><div class="timeline-card"><strong>Rohan Singh</strong><p class="text-muted mb-0">Needs final quiz score</p></div></div></div></div>
        </section>
      </div>
    </main>
  </div>

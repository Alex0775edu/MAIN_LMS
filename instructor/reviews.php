...
<head>
  ...
  <meta name="description" content="Reviews | Dhurandhar Instructor Portal page for the Dhurandhar Enterprise LMS frontend.">
  <title>Reviews | Dhurandhar Instructor Portal</title>
      ...
      <div class="content-area">
        <section class="card-surface">
          <div class="page-header">
            <div>
              <h2>Reviews</h2>
              <p>Capture learner sentiment and reply to feedback quickly.</p>
            </div>
          ...
          <div class="card-surface"><h4 class="fw-bold mb-3">Recent feedback</h4><div class="review-card mb-2"><strong>Meera Shah</strong><p class="text-muted mb-2">“The pacing was excellent and the examples were practical.”</p><button type="button" class="btn btn-outline btn-sm" data-toast="Reply drafted">Reply</button></div><div class="review-card"><strong>Arjun Rao</strong><p class="text-muted mb-2">“The assignments made the content much easier to apply.”</p><button type="button" class="btn btn-outline btn-sm" data-toast="Reply drafted">Reply</button></div></div>
        </section>
      </div>
    </main>
  </div>

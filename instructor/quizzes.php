...
<head>
  ...
  <meta name="description" content="Quizzes | Dhurandhar Instructor Portal page for the Dhurandhar Enterprise LMS frontend.">
  <title>Quizzes | Dhurandhar Instructor Portal</title>
      ...
      <div class="content-area">
        <section class="card-surface">
          <div class="page-header">
            <div>
              <h2>Quizzes</h2>
              <p>Create assessments that keep learners engaged and measured.</p>
            </div>
          ...
          <div class="row g-3"><div class="col-lg-8"><div class="card-surface"><h4 class="fw-bold mb-3">Quiz builder</h4><div class="row g-3"><div class="col-md-6"><label class="form-label">Quiz title</label><input class="form-control" value="Module 1 assessment" name="field"></div><div class="col-md-6"><label class="form-label">Passing score</label><input class="form-control" value="70" name="field"></div><div class="col-12"><label class="form-label">Question bank</label><textarea class="form-control" rows="4" name="field">Multiple choice, true/false, and short coding questions.</textarea></div></div></div></div><div class="col-lg-4"><div class="card-surface"><h4 class="fw-bold mb-3">Question types</h4><div class="d-flex flex-column gap-2"><button type="button" class="btn btn-outline" data-toast="MCQ added">+ Multiple choice</button><button type="button" class="btn btn-outline" data-toast="True/false added">+ True/false</button><button type="button" class="btn btn-outline" data-toast="Coding question added">+ Coding prompt</button></div></div></div></div>
        </section>
      </div>
    </main>
  </div>

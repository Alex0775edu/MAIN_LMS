...
<head>
  ...
  <meta name="description" content="Curriculum Manager | Dhurandhar Instructor Portal page for the Dhurandhar Enterprise LMS frontend.">
  <title>Curriculum Manager | Dhurandhar Instructor Portal</title>
        ...
        <section class="card-surface">
          <div class="page-header">
            <div>
              ...
              <p>Map out the full learning journey and sequencing for each module.</p>
            </div>
          ...
          <div class="card-surface"><div class="page-header"><div><h2>Curriculum structure</h2><p>Organize lessons, checkpoints, and progress milestones clearly.</p></div><button type="button" class="btn btn-primary" data-toast="Curriculum updated">Save Sequence</button></div><div class="row g-3"><div class="col-12"><div class="module-card"><h6 class="fw-bold">Module 1 • Foundations</h6><p class="text-muted mb-2">Lesson 1 • Semantic HTML</p><p class="text-muted mb-2">Lesson 2 • CSS systems</p><p class="text-muted mb-0">Lesson 3 • Accessibility basics</p></div></div><div class="col-12"><div class="module-card"><h6 class="fw-bold">Module 2 • Delivery</h6><p class="text-muted mb-2">Lesson 4 • JavaScript interactions</p><p class="text-muted mb-0">Lesson 5 • Portfolio-ready deployment</p></div></div></div></div>
        </section>
      </div>
    </main>
  </div>

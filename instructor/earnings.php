...
<head>
  ...
  <meta name="description" content="Earnings | Dhurandhar Instructor Portal page for the Dhurandhar Enterprise LMS frontend.">
  <title>Earnings | Dhurandhar Instructor Portal</title>
      ...
      <div class="content-area">
        <section class="card-surface">
          <div class="page-header">
            <div>
              <h2>Earnings</h2>
              <p>Track revenue, payouts, and growth across your teaching portfolio.</p>
            </div>
          ...
          <div class="row g-3"><div class="col-lg-4"><div class="stat-card"><h6 class="text-muted mb-2">Monthly revenue</h6><h3 class="fw-bold">₹74,200</h3><p class="mb-0">This month</p></div></div><div class="col-lg-4"><div class="stat-card"><h6 class="text-muted mb-2">Pending payout</h6><h3 class="fw-bold">₹12,500</h3><p class="mb-0">Ready to withdraw</p></div></div><div class="col-lg-4"><div class="stat-card"><h6 class="text-muted mb-2">Growth</h6><h3 class="fw-bold">+18%</h3><p class="mb-0">Vs. last month</p></div></div><div class="col-12"><div class="card-surface"><h4 class="fw-bold mb-3">Transactions</h4><div class="table-responsive"><table class="table"><thead><tr><th>Date</th><th>Course</th><th>Amount</th><th>Status</th></tr></thead><tbody><tr><td>Apr 01</td><td>AI Foundations</td><td>₹4,999</td><td><span class="badge-chip badge-success">Cleared</span></td></tr><tr><td>Apr 06</td><td>Frontend Systems</td><td>₹3,999</td><td><span class="badge-chip badge-warning">Pending</span></td></tr></tbody></table></div></div></div></div>
        </section>
      </div>
    </main>
  </div>

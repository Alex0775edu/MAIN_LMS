...
<head>
  ...
  <meta name="description" content="Announcements | Dhurandhar Instructor Portal page for the Dhurandhar Enterprise LMS frontend.">
  <title>Announcements | Dhurandhar Instructor Portal</title>
      ...
      <div class="content-area">
        <section class="card-surface">
          <div class="page-header">
            <div>
              <h2>Announcements</h2>
              <p>Broadcast updates and keep your course community informed.</p>
            </div>
          ...
          <div class="row g-3"><div class="col-lg-7"><div class="card-surface"><h4 class="fw-bold mb-3">Compose update</h4><div class="row g-3"><div class="col-md-6"><label class="form-label">Title</label><input class="form-control" value="New cohort starts this week" name="field"></div><div class="col-md-6"><label class="form-label">Audience</label><select class="form-select" name="field"><option>All learners</option><option>AI cohort</option><option>Design cohort</option></select></div><div class="col-12"><label class="form-label">Message</label><textarea class="form-control" rows="4" name="field">Please review the new resources before our first live session.</textarea></div></div></div></div><div class="col-lg-5"><div class="card-surface"><h4 class="fw-bold mb-3">Recent updates</h4><div class="announcement-card mb-2"><strong>New resources published</strong><p class="text-muted mb-0">Pinned for all learners</p></div><div class="announcement-card"><strong>Live class reminder</strong><p class="text-muted mb-0">Scheduled to go out tomorrow</p></div></div></div></div>
        </section>
      </div>
    </main>
  </div>

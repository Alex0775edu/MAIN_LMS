...
<head>
  ...
  <meta name="description" content="Profile | Dhurandhar Instructor Portal page for the Dhurandhar Enterprise LMS frontend.">
  <title>Profile | Dhurandhar Instructor Portal</title>
      ...
      <div class="content-area">
        <section class="card-surface">
          <div class="page-header">
            <div>
              <h2>Profile</h2>
              <p>Showcase your teaching identity, expertise, and credentials.</p>
            </div>

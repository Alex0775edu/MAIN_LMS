...
<head>
  ...
  <meta name="description" content="Resources | Dhurandhar Instructor Portal page for the Dhurandhar Enterprise LMS frontend.">
  <title>Resources | Dhurandhar Instructor Portal</title>
      ...
      <div class="content-area">
        <section class="card-surface">
          <div class="page-header">
            <div>
              <h2>Resources</h2>
              <p>Keep lesson assets, starter files, and external links organized.</p>
            </div>
          ...
          <div class="card-surface"><h4 class="fw-bold mb-3">Course resources</h4><div class="grid-cards"><div class="resource-card"><strong>Workbook</strong><p class="text-muted mb-0">PDF • downloadable</p></div><div class="resource-card"><strong>Figma starter</strong><p class="text-muted mb-0">ZIP • design kit</p></div><div class="resource-card"><strong>Reference link</strong><p class="text-muted mb-0">External article</p></div></div></div>
        </section>
      </div>
    </main>
  </div>

                ...
                <img src="<?php echo htmlspecialchars(lms_site_url('assets/logo-lms.png')); ?>" alt="Dhurandhar LMS Logo" class="logo-img" loading="lazy" width="70" height="70"><span class="text-white">Dhura<span>ndhar</span>
                        ...
                        <div class="col-lg-3 col-md-6" data-aos="fade-up" data-aos-delay="200">
                            <div class="footer-links">
                                ...
                                <ul class="footer-menu">
                                    <li><a href="index.php"><i class="fas fa-chevron-right"></i> Web Development</a>
                                    </li>
                                    <li><a href="index.php"><i class="fas fa-chevron-right"></i> Data Science & AI</a>
                                    </li>
                                    <li><a href="index.php"><i class="fas fa-chevron-right"></i> Mobile App
                                            Development</a></li>
                                    <li><a href="index.php"><i class="fas fa-chevron-right"></i> UI/UX Design</a></li>
                                    <li><a href="index.php"><i class="fas fa-chevron-right"></i> Digital Marketing</a>
                                    </li>
                                    <li><a href="index.php"><i class="fas fa-chevron-right"></i> Cyber Security</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                            ...
                            <div class="footer-contact">
                                ...
                                <div class="contact-info">
                                    <div class="contact-item">
                                        ...
                                        <span>123 Learning Street, Tech Park<br>San Francisco, CA 94105</span>
                                    </div>
                                    <div class="contact-item">
                                        <i class="fas fa-phone-alt"></i>
                                        <span>+91 9023208267</span>
                                    </div>
                                    <div class="contact-item">
                                        <i class="fas fa-envelope"></i>
                                        <span>dhurandhar@gmail.com<br>support@dhurandhar.com</span>
                                    </div>
                                    <div class="contact-item">
                    ...
                    <!-- Newsletter Row -->
                    <div class="newsletter-row" data-aos="fade-up">
                        <div class="row align-items-center">
                            <div class="col-lg-5">
                                <h5 class="newsletter-title">
                                    <i class="fas fa-paper-plane me-2"></i>Subscribe to Our Newsletter
                                </h5>
                                <p class="newsletter-text">Get the latest updates, new courses, and exclusive offers
                                    straight to your inbox.</p>
                            </div>
                            <div class="col-lg-7">
                                <form class="newsletter-form" id="newsletterForm" method="post" novalidate>
                                    <div class="input-group">
                                        <input type="email" class="form-control" placeholder="Enter your email address"
                                            required name="enter_your_email_address">
                ...
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-md-6 text-center text-md-start">
                            <p class="copyright">
                                © 2026 <strong>Dhurandhar LMS</strong>. All Rights Reserved.
                                Crafted with <i class="fas fa-heart text-danger"></i> for learners worldwide.
                            </p>
                        </div>
        ...
        <button type="button" id="scrollTopBtn"
            class="btn btn-primary rounded-circle position-fixed bottom-0 end-0 m-4"><i

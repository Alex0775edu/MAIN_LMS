...
<head>
  ...
  <meta name="description" content="Pages Management | Dhurandhar Super Admin page for the Dhurandhar Enterprise LMS frontend.">
  <title>Pages Management | Dhurandhar Super Admin</title>
  ...
  <div class="app-shell">
    ...
    <main class="main-panel">
      ...
      <div class="content-area">
        <nav class="breadcrumb" aria-label="Breadcrumb"><span>Admin</span><span>/</span><span class="active">Pages Management</span></nav>
        <div class="page-header"><div><h2>Pages Management</h2><p>Manage static pages, legal content, and landing pages.</p></div><div class="d-flex gap-2"><button type="button" class="btn btn-outline" data-toast="Action queued">Quick action</button><button type="button" class="btn btn-primary" data-toast="Saved">Save</button></div></div>
        <div class="card"><div class="page-header"><div><h2>Pages management</h2><p>Build and update public-facing pages for learners and partners.</p></div><button type="button" class="btn btn-outline">Add page</button></div><div class="table-responsive"><table class="table"><thead><tr><th>Page</th><th>Owner</th><th>Status</th></tr></thead><tbody><tr data-search-item><td>About us</td><td>Content team</td><td><span class="chip chip-success">Live</span></td></tr></tbody></table></div></div>
      </div>
    </main>
  </div>

...
<head>
  ...
  <meta name="description" content="Coupons | Dhurandhar Super Admin page for the Dhurandhar Enterprise LMS frontend.">
  <title>Coupons | Dhurandhar Super Admin</title>
  ...
  <div class="app-shell">
    ...
    <main class="main-panel">
      ...
      <div class="content-area">
        <nav class="breadcrumb" aria-label="Breadcrumb"><span>Admin</span><span>/</span><span class="active">Coupons</span></nav>
        <div class="page-header"><div><h2>Coupons</h2><p>Create promotional codes with rules, limits, and expiry handling.</p></div><div class="d-flex gap-2"><button type="button" class="btn btn-outline" data-toast="Action queued">Quick action</button><button type="button" class="btn btn-primary" data-toast="Saved">Save</button></div></div>
        <div class="card"><div class="page-header"><div><h2>Coupon management</h2><p>Configure discounts, validation rules, and promotional windows.</p></div><button type="button" class="btn btn-primary" data-toast="Coupon created">Create coupon</button></div><div class="table-responsive"><table class="table"><thead><tr><th>Code</th><th>Discount</th><th>Valid Until</th><th>Status</th></tr></thead><tbody><tr data-search-item><td>SPRING10</td><td>10%</td><td>Jun 30</td><td><span class="chip chip-success">Active</span></td></tr></tbody></table></div></div>
      </div>
    </main>
  </div>

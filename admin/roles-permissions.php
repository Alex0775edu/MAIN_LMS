...
<head>
  ...
  <meta name="description" content="Roles & Permissions | Dhurandhar Super Admin page for the Dhurandhar Enterprise LMS frontend.">
  <title>Roles & Permissions | Dhurandhar Super Admin</title>
  ...
  <div class="app-shell">
    ...
    <main class="main-panel">
      ...
      <div class="content-area">
        <nav class="breadcrumb" aria-label="Breadcrumb"><span>Admin</span><span>/</span><span class="active">Roles & Permissions</span></nav>
        <div class="page-header"><div><h2>Roles & Permissions</h2><p>Define role hierarchies, permission matrices, and module access rules.</p></div><div class="d-flex gap-2"><button type="button" class="btn btn-outline" data-toast="Action queued">Quick action</button><button type="button" class="btn btn-primary" data-toast="Saved">Save</button></div></div>
        <div class="row g-3"><div class="col-lg-7"><div class="card"><h3 class="fw-bold mb-3">Role matrix</h3><div class="table-responsive"><table class="table"><thead><tr><th>Role</th><th>Dashboard</th><th>Users</th><th>Courses</th><th>Payments</th></tr></thead><tbody><tr><td>Super Admin</td><td>Full</td><td>Full</td><td>Full</td><td>Full</td></tr><tr><td>Institution Admin</td><td>Full</td><td>Limited</td><td>Full</td><td>Limited</td></tr><tr><td>Instructor</td><td>Limited</td><td>None</td><td>Limited</td><td>None</td></tr></tbody></table></div></div></div><div class="col-lg-5"><div class="card"><h3 class="fw-bold mb-3">Assign permissions</h3><div class="accordion"><div class="accordion-item"><button type="button" class="accordion-button">Users & Accounts</button><div class="accordion-body">Create, edit, suspend, and delete users.</div></div><div class="accordion-item"><button type="button" class="accordion-button">Course Moderation</button><div class="accordion-body">Approve, feature, and archive educational content.</div></div></div></div></div></div>
      </div>
    </main>
  </div>

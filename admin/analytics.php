...
<head>
  ...
  <meta name="description" content="Analytics | Dhurandhar Super Admin page for the Dhurandhar Enterprise LMS frontend.">
  <title>Analytics | Dhurandhar Super Admin</title>
  ...
  <div class="app-shell">
    ...
    <main class="main-panel">
      ...
      <div class="content-area">
        <nav class="breadcrumb" aria-label="Breadcrumb"><span>Admin</span><span>/</span><span class="active">Analytics</span></nav>
        <div class="page-header"><div><h2>Analytics</h2><p>Examine platform growth, engagement, completion, and device trends.</p></div><div class="d-flex gap-2"><button type="button" class="btn btn-outline" data-toast="Action queued">Quick action</button><button type="button" class="btn btn-primary" data-toast="Saved">Save</button></div></div>
        <div class="row g-3"><div class="col-lg-8"><div class="card"><h3 class="fw-bold mb-3">Student growth</h3><canvas id="growthChart" height="220"></canvas></div></div><div class="col-lg-4"><div class="card"><h3 class="fw-bold mb-3">Key metrics</h3><div class="list-stack"><div class="stack-row"><strong>Completion rate</strong><span class="chip chip-primary">91%</span></div><div class="stack-row"><strong>Device usage</strong><span class="chip chip-info">Mobile 63%</span></div><div class="stack-row"><strong>Traffic sources</strong><span class="chip chip-success">Organic</span></div></div></div></div></div>
      </div>
    </main>
  </div>

...
<head>
  ...
  <meta name="description" content="System Settings | Dhurandhar Super Admin page for the Dhurandhar Enterprise LMS frontend.">
  <title>System Settings | Dhurandhar Super Admin</title>
  ...
  <div class="app-shell">
    ...
    <main class="main-panel">
      ...
      <div class="content-area">
        <nav class="breadcrumb" aria-label="Breadcrumb"><span>Admin</span><span>/</span><span class="active">System Settings</span></nav>
        <div class="page-header"><div><h2>System Settings</h2><p>Adjust institution-wide configuration and platform defaults.</p></div><div class="d-flex gap-2"><button type="button" class="btn btn-outline" data-toast="Action queued">Quick action</button><button type="button" class="btn btn-primary" data-toast="Saved">Save</button></div></div>
        <div class="card"><div class="page-header"><div><h2>System settings</h2><p>Configure timezone, language, currency, and core platform behavior.</p></div><button type="button" class="btn btn-primary" data-toast="Settings saved">Save</button></div><div class="row g-3"><div class="col-md-6"><label class="form-label">Language</label><select class="form-select" name="field"><option>English</option><option>Hindi</option></select></div><div class="col-md-6"><label class="form-label">Timezone</label><select class="form-select" name="field"><option>Asia/Kolkata</option><option>UTC</option></select></div><div class="col-md-6"><label class="form-label">Currency</label><select class="form-select" name="field"><option>INR</option><option>USD</option></select></div><div class="col-md-6"><label class="form-label">Theme</label><select class="form-select" name="field"><option>Light</option><option>Dark</option></select></div></div></div>
      </div>
    </main>
  </div>

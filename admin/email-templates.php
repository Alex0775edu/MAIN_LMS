...
<head>
  ...
  <meta name="description" content="Email Templates | Dhurandhar Super Admin page for the Dhurandhar Enterprise LMS frontend.">
  <title>Email Templates | Dhurandhar Super Admin</title>
  ...
  <div class="app-shell">
    ...
    <main class="main-panel">
      ...
      <div class="content-area">
        <nav class="breadcrumb" aria-label="Breadcrumb"><span>Admin</span><span>/</span><span class="active">Email Templates</span></nav>
        <div class="page-header"><div><h2>Email Templates</h2><p>Create and manage transactional and campaign email templates.</p></div><div class="d-flex gap-2"><button type="button" class="btn btn-outline" data-toast="Action queued">Quick action</button><button type="button" class="btn btn-primary" data-toast="Saved">Save</button></div></div>
        <div class="card"><div class="page-header"><div><h2>Email templates</h2><p>Design communication for welcome, enrollment, certificate, and reset flows.</p></div><button type="button" class="btn btn-primary" data-toast="Template saved">Create template</button></div><div class="table-responsive"><table class="table"><thead><tr><th>Template</th><th>Purpose</th><th>Status</th></tr></thead><tbody><tr data-search-item><td>Welcome email</td><td>Onboarding</td><td><span class="chip chip-success">Live</span></td></tr></tbody></table></div></div>
      </div>
    </main>
  </div>

...
<head>
  ...
  <meta name="description" content="Course Categories | Dhurandhar Super Admin page for the Dhurandhar Enterprise LMS frontend.">
  <title>Course Categories | Dhurandhar Super Admin</title>
  ...
  <div class="app-shell">
    ...
    <main class="main-panel">
      ...
      <div class="content-area">
        <nav class="breadcrumb" aria-label="Breadcrumb"><span>Admin</span><span>/</span><span class="active">Course Categories</span></nav>
        <div class="page-header"><div><h2>Course Categories</h2><p>Create and manage course groups, taxonomy, and featured category views.</p></div><div class="d-flex gap-2"><button type="button" class="btn btn-outline" data-toast="Action queued">Quick action</button><button type="button" class="btn btn-primary" data-toast="Saved">Save</button></div></div>
        <div class="card"><div class="page-header"><div><h2>Category management</h2><p>Organize courses into logical, searchable, and revenue-friendly groups.</p></div><button type="button" class="btn btn-primary" data-toast="Category created">Add category</button></div><div class="grid-cards"><div class="card"><h5 class="fw-bold">Development</h5><p class="text-muted">124 courses</p></div><div class="card"><h5 class="fw-bold">Business</h5><p class="text-muted">86 courses</p></div><div class="card"><h5 class="fw-bold">AI</h5><p class="text-muted">72 courses</p></div></div></div>
      </div>
    </main>
  </div>

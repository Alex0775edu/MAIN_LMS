...
<head>
  ...
  <meta name="description" content="Staff | Dhurandhar Super Admin page for the Dhurandhar Enterprise LMS frontend.">
  <title>Staff | Dhurandhar Super Admin</title>
  ...
  <div class="app-shell">
    ...
    <main class="main-panel">
      ...
      <div class="content-area">
        <nav class="breadcrumb" aria-label="Breadcrumb"><span>Admin</span><span>/</span><span class="active">Staff</span></nav>
        <div class="page-header"><div><h2>Staff</h2><p>Coordinate administrative and operations staff with role-based visibility.</p></div><div class="d-flex gap-2"><button type="button" class="btn btn-outline" data-toast="Action queued">Quick action</button><button type="button" class="btn btn-primary" data-toast="Saved">Save</button></div></div>
        <div class="card"><div class="page-header"><div><h2>Administrative staff</h2><p>Assign support, operations, and platform supervision areas.</p></div><button type="button" class="btn btn-primary" data-toast="Staff created">Add staff</button></div><div class="table-responsive"><table class="table"><thead><tr><th>Name</th><th>Team</th><th>Access level</th><th>Status</th><th>Actions</th></tr></thead><tbody><tr data-search-item><td>Neha Sharma</td><td>Operations</td><td>Manager</td><td><span class="chip chip-success">Active</span></td><td><button type="button" class="btn btn-outline btn-sm">Edit</button></td></tr></tbody></table></div></div>
      </div>
    </main>
  </div>

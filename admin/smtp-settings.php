...
<head>
  ...
  <meta name="description" content="SMTP Settings | Dhurandhar Super Admin page for the Dhurandhar Enterprise LMS frontend.">
  <title>SMTP Settings | Dhurandhar Super Admin</title>
  ...
  <div class="app-shell">
    ...
    <main class="main-panel">
      ...
      <div class="content-area">
        <nav class="breadcrumb" aria-label="Breadcrumb"><span>Admin</span><span>/</span><span class="active">SMTP Settings</span></nav>
        <div class="page-header"><div><h2>SMTP Settings</h2><p>Configure email delivery settings and service connections.</p></div><div class="d-flex gap-2"><button type="button" class="btn btn-outline" data-toast="Action queued">Quick action</button><button type="button" class="btn btn-primary" data-toast="Saved">Save</button></div></div>
        <div class="card"><div class="page-header"><div><h2>SMTP configuration</h2><p>Set up mail server details, port, encryption, and test delivery.</p></div><button type="button" class="btn btn-primary" data-toast="SMTP saved">Save settings</button></div><div class="row g-3"><div class="col-md-6"><label class="form-label">Host</label><input class="form-control" value="smtp.dhurandhar.com" name="field"></div><div class="col-md-6"><label class="form-label">Port</label><input class="form-control" value="587" name="field"></div><div class="col-md-6"><label class="form-label">Encryption</label><select class="form-select" name="field"><option>TLS</option><option>SSL</option></select></div><div class="col-md-6"><label class="form-label">Sender email</label><input class="form-control" value="noreply@dhurandhar.com" name="field"></div></div></div>
      </div>
    </main>
  </div>

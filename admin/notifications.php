...
<head>
  ...
  <meta name="description" content="Notifications | Dhurandhar Super Admin page for the Dhurandhar Enterprise LMS frontend.">
  <title>Notifications | Dhurandhar Super Admin</title>
  ...
  <div class="app-shell">
    ...
    <main class="main-panel">
      ...
      <div class="content-area">
        <nav class="breadcrumb" aria-label="Breadcrumb"><span>Admin</span><span>/</span><span class="active">Notifications</span></nav>
        <div class="page-header"><div><h2>Notifications</h2><p>Review and manage platform-wide and targeted alerts.</p></div><div class="d-flex gap-2"><button type="button" class="btn btn-outline" data-toast="Action queued">Quick action</button><button type="button" class="btn btn-primary" data-toast="Saved">Save</button></div></div>
        <div class="card"><div class="page-header"><div><h2>Notification center</h2><p>Stay ahead of critical events, approvals, and incoming issues.</p></div><button type="button" class="btn btn-outline" data-toast="All notifications marked read">Mark all read</button></div><div class="list-stack"><div class="stack-row"><strong>New instructor approval</strong><span class="chip chip-warning">Pending</span></div><div class="stack-row"><strong>Backup completed</strong><span class="chip chip-success">Success</span></div></div></div>
      </div>
    </main>
  </div>

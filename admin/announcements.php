...
<head>
  ...
  <meta name="description" content="Announcements | Dhurandhar Super Admin page for the Dhurandhar Enterprise LMS frontend.">
  <title>Announcements | Dhurandhar Super Admin</title>
  ...
  <div class="app-shell">
    ...
    <main class="main-panel">
      ...
      <div class="content-area">
        <nav class="breadcrumb" aria-label="Breadcrumb"><span>Admin</span><span>/</span><span class="active">Announcements</span></nav>
        <div class="page-header"><div><h2>Announcements</h2><p>Publish institution-wide updates, policy changes, and events.</p></div><div class="d-flex gap-2"><button type="button" class="btn btn-outline" data-toast="Action queued">Quick action</button><button type="button" class="btn btn-primary" data-toast="Saved">Save</button></div></div>
        <div class="card"><div class="page-header"><div><h2>Announcements</h2><p>Broadcast updates, reminders, and community-wide notices.</p></div><button type="button" class="btn btn-primary" data-toast="Announcement posted">Create post</button></div><div class="table-responsive"><table class="table"><thead><tr><th>Title</th><th>Audience</th><th>Status</th><th>Posted</th></tr></thead><tbody><tr data-search-item><td>Semester kickoff</td><td>All users</td><td><span class="chip chip-success">Live</span></td><td>Apr 10</td></tr></tbody></table></div></div>
      </div>
    </main>
  </div>

...
<head>
  ...
  <meta name="description" content="Help Center | Dhurandhar Super Admin page for the Dhurandhar Enterprise LMS frontend.">
  <title>Help Center | Dhurandhar Super Admin</title>
  ...
  <div class="app-shell">
    ...
    <main class="main-panel">
      ...
      <div class="content-area">
        <nav class="breadcrumb" aria-label="Breadcrumb"><span>Admin</span><span>/</span><span class="active">Help Center</span></nav>
        <div class="page-header"><div><h2>Help Center</h2><p>Provide administrators with resources, documentation, and support.</p></div><div class="d-flex gap-2"><button type="button" class="btn btn-outline" data-toast="Action queued">Quick action</button><button type="button" class="btn btn-primary" data-toast="Saved">Save</button></div></div>
        <div class="card"><div class="page-header"><div><h2>Help center</h2><p>Access admin docs, quick guides, and escalation pathways.</p></div><button type="button" class="btn btn-outline">Open docs</button></div><div class="list-stack"><div class="stack-row"><strong>How do I approve a course?</strong><span class="chip chip-info">Guide</span></div><div class="stack-row"><strong>How do I restore a backup?</strong><span class="chip chip-info">Guide</span></div></div></div>
      </div>
    </main>
  </div>

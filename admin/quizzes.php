...
<head>
  ...
  <meta name="description" content="Quizzes | Dhurandhar Super Admin page for the Dhurandhar Enterprise LMS frontend.">
  <title>Quizzes | Dhurandhar Super Admin</title>
  ...
  <div class="app-shell">
    ...
    <main class="main-panel">
      ...
      <div class="content-area">
        <nav class="breadcrumb" aria-label="Breadcrumb"><span>Admin</span><span>/</span><span class="active">Quizzes</span></nav>
        <div class="page-header"><div><h2>Quizzes</h2><p>Create, manage, and analyze online assessments.</p></div><div class="d-flex gap-2"><button type="button" class="btn btn-outline" data-toast="Action queued">Quick action</button><button type="button" class="btn btn-primary" data-toast="Saved">Save</button></div></div>
        <div class="card"><div class="page-header"><div><h2>Quiz management</h2><p>Coordinate question banks, timers, and test results.</p></div><button type="button" class="btn btn-primary" data-toast="Quiz created">Create quiz</button></div><div class="table-responsive"><table class="table"><thead><tr><th>Quiz</th><th>Course</th><th>Attempts</th><th>Pass rate</th></tr></thead><tbody><tr data-search-item><td>Module 1 Assessment</td><td>AI Foundations</td><td>246</td><td>84%</td></tr></tbody></table></div></div>
      </div>
    </main>
  </div>

...
<head>
  ...
  <meta name="description" content="Reports | Dhurandhar Super Admin page for the Dhurandhar Enterprise LMS frontend.">
  <title>Reports | Dhurandhar Super Admin</title>
  ...
  <div class="app-shell">
    ...
    <main class="main-panel">
      ...
      <div class="content-area">
        <nav class="breadcrumb" aria-label="Breadcrumb"><span>Admin</span><span>/</span><span class="active">Reports</span></nav>
        <div class="page-header"><div><h2>Reports</h2><p>Generate operational, academic, and financial reports.</p></div><div class="d-flex gap-2"><button type="button" class="btn btn-outline" data-toast="Action queued">Quick action</button><button type="button" class="btn btn-primary" data-toast="Saved">Save</button></div></div>
        <div class="card"><div class="page-header"><div><h2>Reporting center</h2><p>Export data for strategic planning and institutional compliance.</p></div><button type="button" class="btn btn-outline">Schedule report</button></div><div class="table-responsive"><table class="table"><thead><tr><th>Report</th><th>Format</th><th>Last generated</th><th>Status</th></tr></thead><tbody><tr data-search-item><td>Student growth</td><td>PDF</td><td>Apr 12</td><td><span class="chip chip-success">Ready</span></td></tr></tbody></table></div></div>
      </div>
    </main>
  </div>

...
<head>
  ...
  <meta name="description" content="Activity Logs | Dhurandhar Super Admin page for the Dhurandhar Enterprise LMS frontend.">
  <title>Activity Logs | Dhurandhar Super Admin</title>
  ...
  <div class="app-shell">
    ...
    <main class="main-panel">
      ...
      <div class="content-area">
        <nav class="breadcrumb" aria-label="Breadcrumb"><span>Admin</span><span>/</span><span class="active">Activity Logs</span></nav>
        <div class="page-header"><div><h2>Activity Logs</h2><p>Monitor system activity, logins, and operational events.</p></div><div class="d-flex gap-2"><button type="button" class="btn btn-outline" data-toast="Action queued">Quick action</button><button type="button" class="btn btn-primary" data-toast="Saved">Save</button></div></div>
        <div class="card"><div class="page-header"><div><h2>Activity logs</h2><p>Keep a real-time view of platform events and operational signals.</p></div><button type="button" class="btn btn-outline">Filter by date</button></div><div class="table-responsive"><table class="table"><thead><tr><th>Event</th><th>Actor</th><th>Timestamp</th></tr></thead><tbody><tr data-search-item><td>Login successful</td><td>Meera Shah</td><td>11:20</td></tr></tbody></table></div></div>
      </div>
    </main>
  </div>

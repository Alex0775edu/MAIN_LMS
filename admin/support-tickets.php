...
<head>
  ...
  <meta name="description" content="Support Tickets | Dhurandhar Super Admin page for the Dhurandhar Enterprise LMS frontend.">
  <title>Support Tickets | Dhurandhar Super Admin</title>
  ...
  <div class="app-shell">
    ...
    <main class="main-panel">
      ...
      <div class="content-area">
        <nav class="breadcrumb" aria-label="Breadcrumb"><span>Admin</span><span>/</span><span class="active">Support Tickets</span></nav>
        <div class="page-header"><div><h2>Support Tickets</h2><p>Track incoming support requests and resolution status.</p></div><div class="d-flex gap-2"><button type="button" class="btn btn-outline" data-toast="Action queued">Quick action</button><button type="button" class="btn btn-primary" data-toast="Saved">Save</button></div></div>
        <div class="card"><div class="page-header"><div><h2>Support center</h2><p>Monitor support cases, escalation queues, and turnaround priorities.</p></div><button type="button" class="btn btn-outline">Filter queue</button></div><div class="table-responsive"><table class="table"><thead><tr><th>Ticket</th><th>Student</th><th>Priority</th><th>Status</th></tr></thead><tbody><tr data-search-item><td>#1042</td><td>Arjun Rao</td><td><span class="chip chip-warning">High</span></td><td><span class="chip chip-warning">Open</span></td></tr></tbody></table></div></div>
      </div>
    </main>
  </div>

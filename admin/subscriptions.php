...
<head>
  ...
  <meta name="description" content="Subscriptions | Dhurandhar Super Admin page for the Dhurandhar Enterprise LMS frontend.">
  <title>Subscriptions | Dhurandhar Super Admin</title>
  ...
  <div class="app-shell">
    ...
    <main class="main-panel">
      ...
      <div class="content-area">
        <nav class="breadcrumb" aria-label="Breadcrumb"><span>Admin</span><span>/</span><span class="active">Subscriptions</span></nav>
        <div class="page-header"><div><h2>Subscriptions</h2><p>Manage institutional plans, renewals, and membership tiers.</p></div><div class="d-flex gap-2"><button type="button" class="btn btn-outline" data-toast="Action queued">Quick action</button><button type="button" class="btn btn-primary" data-toast="Saved">Save</button></div></div>
        <div class="card"><div class="page-header"><div><h2>Subscriptions</h2><p>Review subscriptions, renewals, plan comparisons, and access tiers.</p></div><button type="button" class="btn btn-outline">Plan comparison</button></div><div class="grid-cards"><div class="card"><h5 class="fw-bold">Starter</h5><p class="text-muted">₹1,999/month</p></div><div class="card"><h5 class="fw-bold">Enterprise</h5><p class="text-muted">₹9,999/month</p></div><div class="card"><h5 class="fw-bold">Campus</h5><p class="text-muted">Custom pricing</p></div></div></div>
      </div>
    </main>
  </div>

...
<head>
  ...
  <meta name="description" content="Payments | Dhurandhar Super Admin page for the Dhurandhar Enterprise LMS frontend.">
  <title>Payments | Dhurandhar Super Admin</title>
  ...
  <div class="app-shell">
    ...
    <main class="main-panel">
      ...
      <div class="content-area">
        <nav class="breadcrumb" aria-label="Breadcrumb"><span>Admin</span><span>/</span><span class="active">Payments</span></nav>
        <div class="page-header"><div><h2>Payments</h2><p>Review billing, refunds, invoices, and payment health.</p></div><div class="d-flex gap-2"><button type="button" class="btn btn-outline" data-toast="Action queued">Quick action</button><button type="button" class="btn btn-primary" data-toast="Saved">Save</button></div></div>
        <div class="card"><div class="page-header"><div><h2>Payments & billing</h2><p>Monitor revenue pipelines, payment gateway health, and invoices.</p></div><button type="button" class="btn btn-outline">Gateway settings</button></div><div class="row g-3"><div class="col-md-4"><div class="stat-card"><h6 class="text-muted">Collected</h6><h3 class="fw-bold">₹8.4M</h3></div></div><div class="col-md-4"><div class="stat-card"><h6 class="text-muted">Refunds</h6><h3 class="fw-bold">₹84K</h3></div></div><div class="col-md-4"><div class="stat-card"><h6 class="text-muted">Pending</h6><h3 class="fw-bold">₹124K</h3></div></div></div></div>
      </div>
    </main>
  </div>

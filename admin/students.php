...
<head>
  ...
  <meta name="description" content="Students | Dhurandhar Super Admin page for the Dhurandhar Enterprise LMS frontend.">
  <title>Students | Dhurandhar Super Admin</title>
  ...
  <div class="app-shell">
    ...
    <main class="main-panel">
      ...
      <div class="content-area">
        <nav class="breadcrumb" aria-label="Breadcrumb"><span>Admin</span><span>/</span><span class="active">Students</span></nav>
        <div class="page-header"><div><h2>Students</h2><p>Track student profiles, enrollments, activity, and academic progress.</p></div><div class="d-flex gap-2"><button type="button" class="btn btn-outline" data-toast="Action queued">Quick action</button><button type="button" class="btn btn-primary" data-toast="Saved">Save</button></div></div>
        <div class="card"><div class="page-header"><div><h2>Student records</h2><p>Review learner development, growth, and intervention needs.</p></div><button type="button" class="btn btn-primary" data-toast="Student report generated">Export report</button></div><div class="table-responsive"><table class="table"><thead><tr><th>Name</th><th>Department</th><th>Progress</th><th>Status</th><th>Actions</th></tr></thead><tbody><tr data-search-item><td>Meera Shah</td><td>Computer Science</td><td>82%</td><td><span class="chip chip-success">Active</span></td><td><button type="button" class="btn btn-outline btn-sm">Profile</button></td></tr><tr data-search-item><td>Arjun Rao</td><td>Business</td><td>64%</td><td><span class="chip chip-warning">At risk</span></td><td><button type="button" class="btn btn-outline btn-sm">Intervene</button></td></tr></tbody></table></div></div>
      </div>
    </main>
  </div>

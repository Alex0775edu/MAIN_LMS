...
<head>
  ...
  <meta name="description" content="Integrations | Dhurandhar Super Admin page for the Dhurandhar Enterprise LMS frontend.">
  <title>Integrations | Dhurandhar Super Admin</title>
  ...
  <div class="app-shell">
    ...
    <main class="main-panel">
      ...
      <div class="content-area">
        <nav class="breadcrumb" aria-label="Breadcrumb"><span>Admin</span><span>/</span><span class="active">Integrations</span></nav>
        <div class="page-header"><div><h2>Integrations</h2><p>Design and manage third-party service connections and hooks.</p></div><div class="d-flex gap-2"><button type="button" class="btn btn-outline" data-toast="Action queued">Quick action</button><button type="button" class="btn btn-primary" data-toast="Saved">Save</button></div></div>
        <div class="card"><div class="page-header"><div><h2>Integrations</h2><p>Connect identity providers, payment gateways, and productivity tools.</p></div><button type="button" class="btn btn-outline">Add connector</button></div><div class="grid-cards"><div class="card"><h5 class="fw-bold">Google Login</h5><p class="text-muted">UI ready</p></div><div class="card"><h5 class="fw-bold">Microsoft Login</h5><p class="text-muted">UI ready</p></div><div class="card"><h5 class="fw-bold">Payment Gateway</h5><p class="text-muted">Placeholder</p></div></div></div>
      </div>
    </main>
  </div>

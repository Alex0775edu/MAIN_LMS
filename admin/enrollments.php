...
<head>
  ...
  <meta name="description" content="Enrollments | Dhurandhar Super Admin page for the Dhurandhar Enterprise LMS frontend.">
  <title>Enrollments | Dhurandhar Super Admin</title>
  ...
  <div class="app-shell">
    ...
    <main class="main-panel">
      ...
      <div class="content-area">
        <nav class="breadcrumb" aria-label="Breadcrumb"><span>Admin</span><span>/</span><span class="active">Enrollments</span></nav>
        <div class="page-header"><div><h2>Enrollments</h2><p>Handle enrollment lifecycle, approvals, refunds, and historical records.</p></div><div class="d-flex gap-2"><button type="button" class="btn btn-outline" data-toast="Action queued">Quick action</button><button type="button" class="btn btn-primary" data-toast="Saved">Save</button></div></div>
        <div class="card"><div class="page-header"><div><h2>Enrollment management</h2><p>Track active, pending, and canceled enrollments from one place.</p></div><button type="button" class="btn btn-outline">Bulk update</button></div><div class="table-responsive"><table class="table"><thead><tr><th>Student</th><th>Course</th><th>Status</th><th>Action</th></tr></thead><tbody><tr data-search-item><td>Meera Shah</td><td>AI Foundations</td><td><span class="chip chip-success">Approved</span></td><td><button type="button" class="btn btn-outline btn-sm">View</button></td></tr><tr data-search-item><td>Arjun Rao</td><td>Design Systems Essentials</td><td><span class="chip chip-warning">Pending</span></td><td><button type="button" class="btn btn-outline btn-sm">Approve</button></td></tr></tbody></table></div></div>
      </div>
    </main>
  </div>

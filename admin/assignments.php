...
<head>
  ...
  <meta name="description" content="Assignments | Dhurandhar Super Admin page for the Dhurandhar Enterprise LMS frontend.">
  <title>Assignments | Dhurandhar Super Admin</title>
  ...
  <div class="app-shell">
    ...
    <main class="main-panel">
      ...
      <div class="content-area">
        <nav class="breadcrumb" aria-label="Breadcrumb"><span>Admin</span><span>/</span><span class="active">Assignments</span></nav>
        <div class="page-header"><div><h2>Assignments</h2><p>Oversee assignment workflows, grading, and submission health.</p></div><div class="d-flex gap-2"><button type="button" class="btn btn-outline" data-toast="Action queued">Quick action</button><button type="button" class="btn btn-primary" data-toast="Saved">Save</button></div></div>
        <div class="card"><div class="page-header"><div><h2>Assignment center</h2><p>Monitor submissions, quality, and grading deadlines across courses.</p></div><button type="button" class="btn btn-outline">Export queue</button></div><div class="table-responsive"><table class="table"><thead><tr><th>Assignment</th><th>Course</th><th>Submissions</th><th>Status</th></tr></thead><tbody><tr data-search-item><td>UI Review</td><td>Design Systems Essentials</td><td>28</td><td><span class="chip chip-warning">Open</span></td></tr></tbody></table></div></div>
      </div>
    </main>
  </div>

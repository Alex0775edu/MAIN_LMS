...
<head>
  ...
  <meta name="description" content="Transactions | Dhurandhar Super Admin page for the Dhurandhar Enterprise LMS frontend.">
  <title>Transactions | Dhurandhar Super Admin</title>
  ...
  <div class="app-shell">
    ...
    <main class="main-panel">
      ...
      <div class="content-area">
        <nav class="breadcrumb" aria-label="Breadcrumb"><span>Admin</span><span>/</span><span class="active">Transactions</span></nav>
        <div class="page-header"><div><h2>Transactions</h2><p>Inspect payment history, statuses, and financial exceptions.</p></div><div class="d-flex gap-2"><button type="button" class="btn btn-outline" data-toast="Action queued">Quick action</button><button type="button" class="btn btn-primary" data-toast="Saved">Save</button></div></div>
        <div class="card"><div class="page-header"><div><h2>Transactions</h2><p>Review the full payment ledger and reconcile billing events.</p></div><button type="button" class="btn btn-outline">Export ledger</button></div><div class="table-responsive"><table class="table"><thead><tr><th>Reference</th><th>Student</th><th>Amount</th><th>Status</th></tr></thead><tbody><tr data-search-item><td>TXN-1024</td><td>Meera Shah</td><td>₹4,999</td><td><span class="chip chip-success">Settled</span></td></tr></tbody></table></div></div>
      </div>
    </main>
  </div>

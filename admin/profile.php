...
<head>
  ...
  <meta name="description" content="Profile | Dhurandhar Super Admin page for the Dhurandhar Enterprise LMS frontend.">
  <title>Profile | Dhurandhar Super Admin</title>
  ...
  <div class="app-shell">
    ...
    <main class="main-panel">
      ...
      <div class="content-area">
        <nav class="breadcrumb" aria-label="Breadcrumb"><span>Admin</span><span>/</span><span class="active">Profile</span></nav>
        <div class="page-header"><div><h2>Profile</h2><p>Manage personal super admin identity, contact details, and security.</p></div><div class="d-flex gap-2"><button type="button" class="btn btn-outline" data-toast="Action queued">Quick action</button><button type="button" class="btn btn-primary" data-toast="Saved">Save</button></div></div>
        <div class="card"><div class="page-header"><div><h2>Admin profile</h2><p>Keep your account details, contact methods, and preferences current.</p></div><button type="button" class="btn btn-primary" data-toast="Profile updated">Save profile</button></div><div class="row g-3"><div class="col-md-6"><label class="form-label">Full name</label><input class="form-control" value="Aditya Rajak" name="field"></div><div class="col-md-6"><label class="form-label">Email</label><input class="form-control" value="rahul@dhurandhar.com" name="field"></div></div></div>
      </div>
    </main>
  </div>

...
<head>
  ...
  <meta name="description" content="Security | Dhurandhar Super Admin page for the Dhurandhar Enterprise LMS frontend.">
  <title>Security | Dhurandhar Super Admin</title>
  ...
  <div class="app-shell">
    ...
    <main class="main-panel">
      ...
      <div class="content-area">
        <nav class="breadcrumb" aria-label="Breadcrumb"><span>Admin</span><span>/</span><span class="active">Security</span></nav>
        <div class="page-header"><div><h2>Security</h2><p>Manage password policy, access control, and protection settings.</p></div><div class="d-flex gap-2"><button type="button" class="btn btn-outline" data-toast="Action queued">Quick action</button><button type="button" class="btn btn-primary" data-toast="Saved">Save</button></div></div>
        <div class="card"><div class="page-header"><div><h2>Security center</h2><p>Control password strength, session rules, and suspicious access behavior.</p></div><button type="button" class="btn btn-primary" data-toast="Security policy saved">Save policy</button></div><div class="row g-3"><div class="col-md-6"><label class="form-label">Password policy</label><select class="form-select" name="field"><option>Strong</option><option>Medium</option></select></div><div class="col-md-6"><label class="form-label">Two-factor auth</label><select class="form-select" name="field"><option>Required</option><option>Optional</option></select></div></div></div>
      </div>
    </main>
  </div>

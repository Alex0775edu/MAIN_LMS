...
<head>
  ...
  <meta name="description" content="Audit Logs | Dhurandhar Super Admin page for the Dhurandhar Enterprise LMS frontend.">
  <title>Audit Logs | Dhurandhar Super Admin</title>
  ...
  <div class="app-shell">
    ...
    <main class="main-panel">
      ...
      <div class="content-area">
        <nav class="breadcrumb" aria-label="Breadcrumb"><span>Admin</span><span>/</span><span class="active">Audit Logs</span></nav>
        <div class="page-header"><div><h2>Audit Logs</h2><p>Review administrative actions, authorizations, and audit trails.</p></div><div class="d-flex gap-2"><button type="button" class="btn btn-outline" data-toast="Action queued">Quick action</button><button type="button" class="btn btn-primary" data-toast="Saved">Save</button></div></div>
        <div class="card"><div class="page-header"><div><h2>Audit logs</h2><p>Inspect user actions, admin changes, and compliance history.</p></div><button type="button" class="btn btn-outline">Export logs</button></div><div class="table-responsive"><table class="table"><thead><tr><th>User</th><th>Action</th><th>Time</th><th>IP</th></tr></thead><tbody><tr data-search-item><td>Aditya Rajak</td><td>Updated role matrix</td><td>09:45</td><td>192.168.1.10</td></tr></tbody></table></div></div>
      </div>
    </main>
  </div>

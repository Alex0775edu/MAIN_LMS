...
<head>
  ...
  <meta name="description" content="API Management | Dhurandhar Super Admin page for the Dhurandhar Enterprise LMS frontend.">
  <title>API Management | Dhurandhar Super Admin</title>
  ...
  <div class="app-shell">
    ...
    <main class="main-panel">
      ...
      <div class="content-area">
        <nav class="breadcrumb" aria-label="Breadcrumb"><span>Admin</span><span>/</span><span class="active">API Management</span></nav>
        <div class="page-header"><div><h2>API Management</h2><p>Control API access, keys, and platform integrations.</p></div><div class="d-flex gap-2"><button type="button" class="btn btn-outline" data-toast="Action queued">Quick action</button><button type="button" class="btn btn-primary" data-toast="Saved">Save</button></div></div>
        <div class="card"><div class="page-header"><div><h2>API management</h2><p>Review API clients, keys, and usage limits.</p></div><button type="button" class="btn btn-primary" data-toast="API key generated">Generate key</button></div><div class="table-responsive"><table class="table"><thead><tr><th>Name</th><th>Key</th><th>Status</th></tr></thead><tbody><tr data-search-item><td>Mobile app</td><td>••••••••</td><td><span class="chip chip-success">Active</span></td></tr></tbody></table></div></div>
      </div>
    </main>
  </div>

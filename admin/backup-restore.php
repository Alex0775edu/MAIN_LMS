...
<head>
  ...
  <meta name="description" content="Backup & Restore | Dhurandhar Super Admin page for the Dhurandhar Enterprise LMS frontend.">
  <title>Backup & Restore | Dhurandhar Super Admin</title>
  ...
  <div class="app-shell">
    ...
    <main class="main-panel">
      ...
      <div class="content-area">
        <nav class="breadcrumb" aria-label="Breadcrumb"><span>Admin</span><span>/</span><span class="active">Backup & Restore</span></nav>
        <div class="page-header"><div><h2>Backup & Restore</h2><p>Create backups, restore snapshots, and monitor recovery readiness.</p></div><div class="d-flex gap-2"><button type="button" class="btn btn-outline" data-toast="Action queued">Quick action</button><button type="button" class="btn btn-primary" data-toast="Saved">Save</button></div></div>
        <div class="card"><div class="page-header"><div><h2>Backup & restore</h2><p>Protect critical data with scheduled backup controls and restore readiness.</p></div><button type="button" class="btn btn-primary" data-toast="Backup started">Create backup</button></div><div class="table-responsive"><table class="table"><thead><tr><th>Backup</th><th>Date</th><th>Size</th><th>Status</th></tr></thead><tbody><tr data-search-item><td>Full platform backup</td><td>Apr 24</td><td>2.4 GB</td><td><span class="chip chip-success">Complete</span></td></tr></tbody></table></div></div>
      </div>
    </main>
  </div>

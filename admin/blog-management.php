...
<head>
  ...
  <meta name="description" content="Blog Management | Dhurandhar Super Admin page for the Dhurandhar Enterprise LMS frontend.">
  <title>Blog Management | Dhurandhar Super Admin</title>
  ...
  <div class="app-shell">
    ...
    <main class="main-panel">
      ...
      <div class="content-area">
        <nav class="breadcrumb" aria-label="Breadcrumb"><span>Admin</span><span>/</span><span class="active">Blog Management</span></nav>
        <div class="page-header"><div><h2>Blog Management</h2><p>Create and schedule institutional blog posts and editorial content.</p></div><div class="d-flex gap-2"><button type="button" class="btn btn-outline" data-toast="Action queued">Quick action</button><button type="button" class="btn btn-primary" data-toast="Saved">Save</button></div></div>
        <div class="card"><div class="page-header"><div><h2>Blog management</h2><p>Plan posts, review drafts, and publish thought leadership.</p></div><button type="button" class="btn btn-primary" data-toast="Blog drafted">Create post</button></div><div class="table-responsive"><table class="table"><thead><tr><th>Title</th><th>Author</th><th>Status</th><th>Published</th></tr></thead><tbody><tr data-search-item><td>How institutions scale digital learning</td><td>Priya S.</td><td><span class="chip chip-success">Published</span></td><td>Apr 18</td></tr></tbody></table></div></div>
      </div>
    </main>
  </div>

...
<head>
  ...
  <meta name="description" content="Maintenance Mode | Dhurandhar Super Admin page for the Dhurandhar Enterprise LMS frontend.">
  <title>Maintenance Mode | Dhurandhar Super Admin</title>
  ...
  <div class="app-shell">
    ...
    <main class="main-panel">
      ...
      <div class="content-area">
        <nav class="breadcrumb" aria-label="Breadcrumb"><span>Admin</span><span>/</span><span class="active">Maintenance Mode</span></nav>
        <div class="page-header"><div><h2>Maintenance Mode</h2><p>Control temporary downtime, updates, and maintenance messaging.</p></div><div class="d-flex gap-2"><button type="button" class="btn btn-outline" data-toast="Action queued">Quick action</button><button type="button" class="btn btn-primary" data-toast="Saved">Save</button></div></div>
        <div class="card"><div class="page-header"><div><h2>Maintenance mode</h2><p>Switch the platform into a controlled maintenance state.</p></div><button type="button" class="btn btn-warning" data-toast="Maintenance mode updated">Toggle mode</button></div><div class="row g-3"><div class="col-md-6"><label class="form-label">Message</label><input class="form-control" value="We are improving the platform now" name="field"></div><div class="col-md-6"><label class="form-label">Status</label><select class="form-select" name="field"><option>Disabled</option><option>Enabled</option></select></div></div></div>
      </div>
    </main>
  </div>

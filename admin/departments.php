...
<head>
  ...
  <meta name="description" content="Departments | Dhurandhar Super Admin page for the Dhurandhar Enterprise LMS frontend.">
  <title>Departments | Dhurandhar Super Admin</title>
  ...
  <div class="app-shell">
    ...
    <main class="main-panel">
      ...
      <div class="content-area">
        <nav class="breadcrumb" aria-label="Breadcrumb"><span>Admin</span><span>/</span><span class="active">Departments</span></nav>
        <div class="page-header"><div><h2>Departments</h2><p>Organize institutional units, ownership, and admin coverage.</p></div><div class="d-flex gap-2"><button type="button" class="btn btn-outline" data-toast="Action queued">Quick action</button><button type="button" class="btn btn-primary" data-toast="Saved">Save</button></div></div>
        <div class="card"><div class="page-header"><div><h2>Departments</h2><p>Manage departments, associated faculty, and internal ownership.</p></div><button type="button" class="btn btn-primary" data-toast="Department saved">Add department</button></div><div class="grid-cards"><div class="card"><h5 class="fw-bold">Computer Science</h5><p class="text-muted">Lead: Dr. Asha Patel</p></div><div class="card"><h5 class="fw-bold">Business</h5><p class="text-muted">Lead: Prof. Nitin Joshi</p></div><div class="card"><h5 class="fw-bold">Design</h5><p class="text-muted">Lead: Priya S.</p></div></div></div>
      </div>
    </main>
  </div>

...
<head>
  ...
  <meta name="description" content="CMS | Dhurandhar Super Admin page for the Dhurandhar Enterprise LMS frontend.">
  <title>CMS | Dhurandhar Super Admin</title>
  ...
  <div class="app-shell">
    ...
    <main class="main-panel">
      ...
      <div class="content-area">
        <nav class="breadcrumb" aria-label="Breadcrumb"><span>Admin</span><span>/</span><span class="active">CMS</span></nav>
        <div class="page-header"><div><h2>CMS</h2><p>Manage the public-facing content areas and editorial workflows.</p></div><div class="d-flex gap-2"><button type="button" class="btn btn-outline" data-toast="Action queued">Quick action</button><button type="button" class="btn btn-primary" data-toast="Saved">Save</button></div></div>
        <div class="card"><div class="page-header"><div><h2>Content management</h2><p>Update home sections, navigation, banners, and static pages.</p></div><button type="button" class="btn btn-primary" data-toast="CMS saved">Save</button></div><div class="row g-3"><div class="col-md-6"><label class="form-label">Homepage banner</label><input class="form-control" value="Student success stories" name="field"></div><div class="col-md-6"><label class="form-label">Footer text</label><input class="form-control" value="Trusted by universities and enterprise teams" name="field"></div></div></div>
      </div>
    </main>
  </div>

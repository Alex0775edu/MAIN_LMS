...
<head>
  ...
  <meta name="description" content="Database Tools | Dhurandhar Super Admin page for the Dhurandhar Enterprise LMS frontend.">
  <title>Database Tools | Dhurandhar Super Admin</title>
  ...
  <div class="app-shell">
    ...
    <main class="main-panel">
      ...
      <div class="content-area">
        <nav class="breadcrumb" aria-label="Breadcrumb"><span>Admin</span><span>/</span><span class="active">Database Tools</span></nav>
        <div class="page-header"><div><h2>Database Tools</h2><p>Prepare admin tools for schema review, exports, and maintenance.</p></div><div class="d-flex gap-2"><button type="button" class="btn btn-outline" data-toast="Action queued">Quick action</button><button type="button" class="btn btn-primary" data-toast="Saved">Save</button></div></div>
        <div class="card"><div class="page-header"><div><h2>Database tools</h2><p>Inspect tables, perform maintenance tasks, and prepare exports.</p></div><button type="button" class="btn btn-outline">Run check</button></div><div class="table-responsive"><table class="table"><thead><tr><th>Tool</th><th>Description</th><th>Status</th></tr></thead><tbody><tr data-search-item><td>Schema check</td><td>Review tables and indexes</td><td><span class="chip chip-success">Healthy</span></td></tr></tbody></table></div></div>
      </div>
    </main>
  </div>

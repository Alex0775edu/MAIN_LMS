...
<head>
  ...
  <meta name="description" content="Course Reviews | Dhurandhar Super Admin page for the Dhurandhar Enterprise LMS frontend.">
  <title>Course Reviews | Dhurandhar Super Admin</title>
  ...
  <div class="app-shell">
    ...
    <main class="main-panel">
      ...
      <div class="content-area">
        <nav class="breadcrumb" aria-label="Breadcrumb"><span>Admin</span><span>/</span><span class="active">Course Reviews</span></nav>
        <div class="page-header"><div><h2>Course Reviews</h2><p>Moderate learner sentiment, flag issues, and improve trust.</p></div><div class="d-flex gap-2"><button type="button" class="btn btn-outline" data-toast="Action queued">Quick action</button><button type="button" class="btn btn-primary" data-toast="Saved">Save</button></div></div>
        <div class="card"><div class="page-header"><div><h2>Course reviews</h2><p>Review feedback, resolve concerns, and mark content fit for promotion.</p></div><button type="button" class="btn btn-outline">Filter reviews</button></div><div class="table-responsive"><table class="table"><thead><tr><th>Course</th><th>Reviewer</th><th>Rating</th><th>Status</th></tr></thead><tbody><tr data-search-item><td>AI Foundations</td><td>Meera Shah</td><td>5/5</td><td><span class="chip chip-success">Approved</span></td></tr><tr data-search-item><td>Design Systems Essentials</td><td>Arjun Rao</td><td>3/5</td><td><span class="chip chip-warning">Pending</span></td></tr></tbody></table></div></div>
      </div>
    </main>
  </div>

...
<head>
  ...
  <meta name="description" content="Media Library | Dhurandhar Super Admin page for the Dhurandhar Enterprise LMS frontend.">
  <title>Media Library | Dhurandhar Super Admin</title>
  ...
  <div class="app-shell">
    ...
    <main class="main-panel">
      ...
      <div class="content-area">
        <nav class="breadcrumb" aria-label="Breadcrumb"><span>Admin</span><span>/</span><span class="active">Media Library</span></nav>
        <div class="page-header"><div><h2>Media Library</h2><p>Organize images, videos, documents, and downloadable assets.</p></div><div class="d-flex gap-2"><button type="button" class="btn btn-outline" data-toast="Action queued">Quick action</button><button type="button" class="btn btn-primary" data-toast="Saved">Save</button></div></div>
        <div class="card"><div class="page-header"><div><h2>Media library</h2><p>Upload, categorize, and manage shared digital assets.</p></div><button type="button" class="btn btn-primary" data-toast="Media uploaded">Upload media</button></div><div class="grid-cards"><div class="card"><h5 class="fw-bold">Hero banner</h5><p class="text-muted">PNG • 3.2 MB</p></div><div class="card"><h5 class="fw-bold">Course trailer</h5><p class="text-muted">MP4 • 40 MB</p></div><div class="card"><h5 class="fw-bold">Policy PDF</h5><p class="text-muted">PDF • 840 KB</p></div></div></div>
      </div>
    </main>
  </div>

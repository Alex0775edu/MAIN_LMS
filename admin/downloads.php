...
<head>
  ...
  <meta name="description" content="Downloads | Dhurandhar Super Admin page for the Dhurandhar Enterprise LMS frontend.">
  <title>Downloads | Dhurandhar Super Admin</title>
  ...
  <div class="app-shell">
    ...
    <main class="main-panel">
      ...
      <div class="content-area">
        <nav class="breadcrumb" aria-label="Breadcrumb"><span>Admin</span><span>/</span><span class="active">Downloads</span></nav>
        <div class="page-header"><div><h2>Downloads</h2><p>Monitor downloadable content and asset usage.</p></div><div class="d-flex gap-2"><button type="button" class="btn btn-outline" data-toast="Action queued">Quick action</button><button type="button" class="btn btn-primary" data-toast="Saved">Save</button></div></div>
        <div class="card"><div class="page-header"><div><h2>Downloads</h2><p>Track file usage, campus downloads, and popular documents.</p></div><button type="button" class="btn btn-outline">Export report</button></div><div class="table-responsive"><table class="table"><thead><tr><th>File</th><th>Downloads</th><th>Type</th></tr></thead><tbody><tr data-search-item><td>Student handbook</td><td>1,240</td><td>PDF</td></tr></tbody></table></div></div>
      </div>
    </main>
  </div>

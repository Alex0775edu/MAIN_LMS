...
<head>
  ...
  <meta name="description" content="Messages | Dhurandhar Super Admin page for the Dhurandhar Enterprise LMS frontend.">
  <title>Messages | Dhurandhar Super Admin</title>
  ...
  <div class="app-shell">
    ...
    <main class="main-panel">
      ...
      <div class="content-area">
        <nav class="breadcrumb" aria-label="Breadcrumb"><span>Admin</span><span>/</span><span class="active">Messages</span></nav>
        <div class="page-header"><div><h2>Messages</h2><p>Coordinate internal communications across admins and staff.</p></div><div class="d-flex gap-2"><button type="button" class="btn btn-outline" data-toast="Action queued">Quick action</button><button type="button" class="btn btn-primary" data-toast="Saved">Save</button></div></div>
        <div class="row g-3"><div class="col-lg-5"><div class="card"><h3 class="fw-bold mb-3">Channels</h3><div class="list-stack"><div class="stack-row"><strong>Support Ops</strong><span class="chip chip-primary">4 unread</span></div><div class="stack-row"><strong>Finance</strong><span class="chip chip-info">2 unread</span></div></div></div></div><div class="col-lg-7"><div class="card"><h3 class="fw-bold mb-3">Inbox</h3><div class="stack-row"><strong>New payment exception</strong><p class="text-muted mb-0">Please review before noon.</p></div></div></div></div>
      </div>
    </main>
  </div>

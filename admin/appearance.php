...
<head>
  ...
  <meta name="description" content="Appearance | Dhurandhar Super Admin page for the Dhurandhar Enterprise LMS frontend.">
  <title>Appearance | Dhurandhar Super Admin</title>
  ...
  <div class="app-shell">
    ...
    <main class="main-panel">
      ...
      <div class="content-area">
        <nav class="breadcrumb" aria-label="Breadcrumb"><span>Admin</span><span>/</span><span class="active">Appearance</span></nav>
        <div class="page-header"><div><h2>Appearance</h2><p>Customize branding, theme, and presentation settings.</p></div><div class="d-flex gap-2"><button type="button" class="btn btn-outline" data-toast="Action queued">Quick action</button><button type="button" class="btn btn-primary" data-toast="Saved">Save</button></div></div>
        <div class="card"><div class="page-header"><div><h2>Appearance</h2><p>Brand the admin experience with logos, colors, and polished UI options.</p></div><button type="button" class="btn btn-primary" data-toast="Appearance updated">Save branding</button></div><div class="row g-3"><div class="col-md-6"><label class="form-label">Logo</label><input class="form-control" type="file" name="field"></div><div class="col-md-6"><label class="form-label">Favicon</label><input class="form-control" type="file" name="field"></div></div></div>
      </div>
    </main>
  </div>

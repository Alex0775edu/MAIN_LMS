...
<head>
  ...
  <meta name="description" content="Users | Dhurandhar Super Admin page for the Dhurandhar Enterprise LMS frontend.">
  <title>Users | Dhurandhar Super Admin</title>
  ...
  <div class="app-shell">
    ...
    <main class="main-panel">
      ...
      <div class="content-area">
        ...
        <div class="page-header"><div><h2>Users</h2><p>Manage platform users, status, roles, and bulk operations from a single workspace.</p></div><div class="d-flex gap-2"><button type="button" class="btn btn-outline" data-toast="Action queued">Quick action</button><button type="button" class="btn btn-primary" data-toast="Saved">Save</button></div></div>
        <div class="card"><div class="page-header"><div><h2>User management</h2><p>Search, filter, sort, and perform bulk actions across every account type.</p></div><div class="d-flex gap-2"><button type="button" class="btn btn-outline" data-toast="Import panel ready">Import</button><button type="button" class="btn btn-outline" data-toast="Export ready">Export</button><button type="button" class="btn btn-primary" data-toast="User created">Create User</button></div></div><div class="row g-3 mb-3"><div class="col-md-4"><input class="form-control" type="text" placeholder="Search user" data-search name="search_user"></div><div class="col-md-3"><select class="form-select" name="field"><option>All roles</option><option>Admin</option><option>Instructor</option><option>Student</option></select></div><div class="col-md-3"><select class="form-select" name="field"><option>All statuses</option><option>Active</option><option>Suspended</option></select></div><div class="col-md-2"><button type="button" class="btn btn-outline w-100">Filter</button></div></div><div class="table-responsive"><table class="table"><thead><tr><th>Name</th><th>Email</th><th>Role</th><th>Status</th><th>Actions</th></tr></thead><tbody><tr data-search-item><td>Rahul Verma</td><td>rahul@dhurandhar.com</td><td>Super Admin</td><td><span class="chip chip-success">Active</span></td><td><button type="button" class="btn btn-outline btn-sm" data-toast="User viewed">View</button></td></tr><tr data-search-item><td>Meera Shah</td><td>meera@school.edu</td><td>Student</td><td><span class="chip chip-warning">Pending</span></td><td><button type="button" class="btn btn-outline btn-sm" data-toast="User edited">Edit</button></td></tr></tbody></table></div><nav class="mt-3" aria-label="Pagination"><ul class="pagination justify-content-end mb-0"><li class="page-item active"><a class="page-link" href="users.php?page=1">1</a></li><li class="page-item"><a class="page-link" href="users.php?page=2">2</a></li><li class="page-item"><a class="page-link" href="users.php?page=3">3</a></li></ul></nav></div>
      </div>
    </main>
  </div>

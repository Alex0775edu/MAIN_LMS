...
<head>
    ...
    <meta name="description" content="Dhurandhar LMS | Leaderboard page for student rankings.">
    <title>Dhurandhar LMS | Leaderboard</title>
    ...
    <div class="dashboard-shell">
        <aside class="sidebar" id="sidebar">
            ...
            <nav class="sidebar-nav" aria-label="Student dashboard navigation">
                ...
                <a href="leaderboard.php" class="nav-item active"><i class="fas fa-trophy"></i><span>Leaderboard</span></a>
        ...
        <div class="main-panel">
            <header class="topbar">
                ...
                <div><p class="topbar-label">Student Dashboard</p><h1>Leaderboard</h1></div>
            ...
            <main class="content-area">
                <section class="card-section" data-aos="fade-up">
                    <div class="section-heading">
                        <div><span class="section-badge">Top Students</span><h3>This week's ranking</h3></div>
                    </div>

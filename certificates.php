...
<head>
  ...
  <meta name="description" content="Certificates | Dhurandhar Super Admin page for the Dhurandhar Enterprise LMS frontend.">
  <title>Certificates | Dhurandhar Super Admin</title>
  ...
  <div class="app-shell">
    ...
    <main class="main-panel">
      ...
      <div class="content-area">
        <nav class="breadcrumb" aria-label="Breadcrumb"><span>Admin</span><span>/</span><span class="active">Certificates</span></nav>
        <div class="page-header"><div><h2>Certificates</h2><p>Issue and manage completion credentials and verifications.</p></div><div class="d-flex gap-2"><button type="button" class="btn btn-outline" data-toast="Action queued">Quick action</button><button type="button" class="btn btn-primary" data-toast="Saved">Save</button></div></div>
        <div class="card"><div class="page-header"><div><h2>Certificate management</h2><p>Issue credentials, monitor validity, and review verification requests.</p></div><button type="button" class="btn btn-outline">Bulk export</button></div><div class="table-responsive"><table class="table"><thead><tr><th>Certificate</th><th>Recipient</th><th>Status</th><th>Issued</th></tr></thead><tbody><tr data-search-item><td>AI Foundations</td><td>Meera Shah</td><td><span class="chip chip-success">Issued</span></td><td>Apr 12</td></tr></tbody></table></div></div>
      </div>
    </main>
  </div>

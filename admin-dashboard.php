  ...
  <div class="app-shell">
    <aside class="sidebar">
      ...
      <nav class="sidebar-nav" aria-label="Super admin navigation">
        <a class="nav-item active" href="admin-dashboard.php"><i class="fas fa-home"></i><span>Dashboard</span></a>
        <a class="nav-item" href="users.php"><i class="fas fa-users"></i><span>Users</span></a>
        <a class="nav-item" href="students.php"><i class="fas fa-user-graduate"></i><span>Students</span></a>
        <a class="nav-item" href="instructors.php"><i class="fas fa-chalkboard-teacher"></i><span>Instructors</span></a>
        <a class="nav-item" href="staff.php"><i class="fas fa-user-shield"></i><span>Staff</span></a>
        <a class="nav-item" href="roles-permissions.php"><i class="fas fa-key"></i><span>Roles & Permissions</span></a>
        <a class="nav-item" href="departments.php"><i class="fas fa-building"></i><span>Departments</span></a>
        <a class="nav-item" href="courses.php"><i class="fas fa-book-open"></i><span>Courses</span></a>
        <a class="nav-item" href="course-categories.php"><i class="fas fa-tags"></i><span>Course Categories</span></a>
        <a class="nav-item" href="course-reviews.php"><i class="fas fa-star"></i><span>Course Reviews</span></a>
        <a class="nav-item" href="enrollments.php"><i class="fas fa-file-signature"></i><span>Enrollments</span></a>
        <a class="nav-item" href="learning-paths.php"><i class="fas fa-route"></i><span>Learning Paths</span></a>
        <a class="nav-item" href="assignments.php"><i class="fas fa-clipboard-list"></i><span>Assignments</span></a>
        <a class="nav-item" href="quizzes.php"><i class="fas fa-brain"></i><span>Quizzes</span></a>
        <a class="nav-item" href="certificates.php"><i class="fas fa-award"></i><span>Certificates</span></a>
        <a class="nav-item" href="payments.php"><i class="fas fa-credit-card"></i><span>Payments</span></a>
        <a class="nav-item" href="transactions.php"><i class="fas fa-exchange-alt"></i><span>Transactions</span></a>
        <a class="nav-item" href="coupons.php"><i class="fas fa-ticket-alt"></i><span>Coupons</span></a>
        <a class="nav-item" href="subscriptions.php"><i class="fas fa-crown"></i><span>Subscriptions</span></a>
        <a class="nav-item" href="reports.php"><i class="fas fa-chart-pie"></i><span>Reports</span></a>
        <a class="nav-item" href="analytics.php"><i class="fas fa-chart-bar"></i><span>Analytics</span></a>
        <a class="nav-item" href="notifications.php"><i class="fas fa-bell"></i><span>Notifications</span></a>
        <a class="nav-item" href="announcements.php"><i class="fas fa-bullhorn"></i><span>Announcements</span></a>
        <a class="nav-item" href="messages.php"><i class="fas fa-envelope"></i><span>Messages</span></a>
        <a class="nav-item" href="support-tickets.php"><i class="fas fa-headset"></i><span>Support Tickets</span></a>
        <a class="nav-item" href="cms.php"><i class="fas fa-puzzle-piece"></i><span>CMS</span></a>
        <a class="nav-item" href="blog-management.php"><i class="fas fa-blog"></i><span>Blog Management</span></a>
        <a class="nav-item" href="pages-management.php"><i class="fas fa-file-alt"></i><span>Pages Management</span></a>
        <a class="nav-item" href="media-library.php"><i class="fas fa-photo-video"></i><span>Media Library</span></a>
        <a class="nav-item" href="downloads.php"><i class="fas fa-download"></i><span>Downloads</span></a>
        <a class="nav-item" href="email-templates.php"><i class="fas fa-mail-bulk"></i><span>Email Templates</span></a>
        <a class="nav-item" href="smtp-settings.php"><i class="fas fa-satellite-dish"></i><span>SMTP Settings</span></a>
        <a class="nav-item" href="system-settings.php"><i class="fas fa-cogs"></i><span>System Settings</span></a>
        <a class="nav-item" href="appearance.php"><i class="fas fa-palette"></i><span>Appearance</span></a>
        <a class="nav-item" href="security.php"><i class="fas fa-shield-alt"></i><span>Security</span></a>
        <a class="nav-item" href="backup-restore.php"><i class="fas fa-database"></i><span>Backup & Restore</span></a>
        <a class="nav-item" href="audit-logs.php"><i class="fas fa-clipboard-check"></i><span>Audit Logs</span></a>
        <a class="nav-item" href="activity-logs.php"><i class="fas fa-history"></i><span>Activity Logs</span></a>
        <a class="nav-item" href="integrations.php"><i class="fas fa-plug"></i><span>Integrations</span></a>
        <a class="nav-item" href="api-management.php"><i class="fas fa-code"></i><span>API Management</span></a>
        <a class="nav-item" href="database-tools.php"><i class="fas fa-server"></i><span>Database Tools</span></a>
        <a class="nav-item" href="maintenance-mode.php"><i class="fas fa-tools"></i><span>Maintenance Mode</span></a>
